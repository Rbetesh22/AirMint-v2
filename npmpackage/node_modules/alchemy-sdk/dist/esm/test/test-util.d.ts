...
import { BaseNft, Media, Nft, NftContract, NftSaleMarketplace, NftSaleTakerType, NftTokenType, OwnedBaseNft, OwnedNft, TokenUri } from '../src';
import { RawBaseNft, RawContractBaseNft, RawContractForOwner, RawNft, RawNftContract, RawNftContractMetadata, RawNftSale, RawOpenSeaCollectionMetadata, RawOwnedBaseNft, RawOwnedNft } from '../src/internal/raw-interfaces';
...
export declare function createRawBaseNft(contractAddress: string, tokenId: string | number, tokenType?: NftTokenType): RawBaseNft;
...
export declare function createRawNft(contractAddress: string, title: string, tokenId: string, tokenType?: NftTokenType, options?: RawNftOptions): RawNft;
...
export declare function createRawContractForOwner(address: string, tokenId: string, media: Media, isSpam?: boolean, name?: string, tokenType?: NftTokenType, symbol?: string, totalSupply?: string, opensea?: RawOpenSeaCollectionMetadata): RawContractForOwner;
export declare function createNftMediaData(bytes?: number, format?: string, thumbnail?: string): Media;
