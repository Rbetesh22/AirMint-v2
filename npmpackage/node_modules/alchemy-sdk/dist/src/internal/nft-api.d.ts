...
export declare function checkNftOwnership(config: AlchemyConfig, owner: string, contractAddresses: string[], srcMethod?: string): Promise<boolean>;
...
export declare function isSpamContract(config: AlchemyConfig, contractAddress: string, srcMethod?: string): Promise<boolean>;
export declare function getSpamContracts(config: AlchemyConfig, srcMethod?: string): Promise<string[]>;
...
export declare function computeRarity(config: AlchemyConfig, contractAddress: string, tokenId: BigNumberish, srcMethod?: string): Promise<NftAttributeRarity[]>;
export declare function searchContractMetadata(config: AlchemyConfig, query: string, srcMethod?: string): Promise<NftContract[]>;
