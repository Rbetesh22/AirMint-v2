...
export default class TwitterApiv2ReadWrite extends TwitterApiv2ReadOnly {
     ...
     */
    sendDmInConversation(conversationId: number, message: PostDMInConversationParams): Promise<PostDMInConversationResult>;
    /**
     ...
     */
    sendDmToParticipant(participantId: number, message: PostDMInConversationParams): Promise<PostDMInConversationResult>;
    /**
