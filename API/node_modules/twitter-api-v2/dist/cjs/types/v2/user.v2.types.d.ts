...
export declare type UserV2MuteResult = DataV2<{
    muting: boolean;
}>;
export declare type UserV2TimelineResult = DataMetaAndIncludeV2<UserV2[], PaginableCountMetaV2, ApiV2Includes>;
/** @deprecated Use {UserV2TimelineResult} instead. */
export declare type FollowersV2Result = UserV2TimelineResult;
